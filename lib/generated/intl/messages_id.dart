...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Apakah Anda yakin Anda ingin menghapus grup langganan ${name}?";
  ...
  static String m6(snapshotData) => "Mengimpor ${snapshotData} pengguna sejauh ini";

  static String m7(date) => "Bergabung ${date}";

  static String m9(errorMessage) => "Mohon periksa koneksi Internet Anda.\n\n${errorMessage}";

  static String m10(releaseVersion) => "Ketuk untuk mengunduh ${releaseVersion}";
  ...
  static String m13(filePath) => "Berkas tidak ada. Pastikan bahwa itu terletak di ${filePath}";

  static String m14(thisTweetUserName) => "${thisTweetUserName} mencuit ulang";

  static String m16(widgetPlaceName) => "Tidak bisa memuat tren untuk ${widgetPlaceName}";

  static String m17(e) => "Tidak bisa menyegarkan langganan. Galatnya adalah ${e}";
  ...
  static String m20(statusCode) => "Tidak bisa mengirim ping. Kode statusnya adalah ${statusCode}";

  static String m21(releaseVersion) => "Perbarui ke ${releaseVersion} lewat klien F-Droid Anda";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "about": MessageLookupByLibrary.simpleMessage("Tentang"),
        "account_suspended": MessageLookupByLibrary.simpleMessage("Akun ditangguhkan"),
        ...
        "catastrophic_failure": MessageLookupByLibrary.simpleMessage("Kegagalan serius"),
        "contribute": MessageLookupByLibrary.simpleMessage("Kontribusi"),
        "copied_address_to_clipboard": MessageLookupByLibrary.simpleMessage("Salin alamat ke papan klip"),
        "copied_version_to_clipboard": MessageLookupByLibrary.simpleMessage("Salin versi ke papan klip"),
        "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Tidak bisa menghubungi Twitter"),
        "could_not_find_any_tweets_by_this_user":
            MessageLookupByLibrary.simpleMessage("Tidak bisa mencari cuitan apa pun dari pengguna ini!"),
        "could_not_find_any_tweets_from_the_last_7_days":
            MessageLookupByLibrary.simpleMessage("Tidak bisa menemukan cuitan apa pun dari 7 hari terakhir!"),
        "country": MessageLookupByLibrary.simpleMessage("Negara"),
        "dark": MessageLookupByLibrary.simpleMessage("Gelap"),
        "data": MessageLookupByLibrary.simpleMessage("Data"),
        "data_exported_to_fileName": m1,
        "data_exported_to_fullPath": m2,
        "data_imported_successfully": MessageLookupByLibrary.simpleMessage("Data berhasil diimpor"),
        "date_created": MessageLookupByLibrary.simpleMessage("Tanggal Dibuat"),
        "date_subscribed": MessageLookupByLibrary.simpleMessage("Tanggal Berlangganan"),
        ...
        "export_settings": MessageLookupByLibrary.simpleMessage("Ekspor pengaturan?"),
        "export_subscription_group_members": MessageLookupByLibrary.simpleMessage("Ekspor anggota grup langganan?"),
        "export_subscription_groups": MessageLookupByLibrary.simpleMessage("Ekspor grup langganan?"),
        "export_subscriptions": MessageLookupByLibrary.simpleMessage("Ekspor langganan?"),
        "export_tweets": MessageLookupByLibrary.simpleMessage("Ekspor cuitan?"),
        "export_your_data": MessageLookupByLibrary.simpleMessage("Ekspor data Anda"),
        ...
        "if_you_have_any_feedback_on_this_feature_please_leave_it_on":
            MessageLookupByLibrary.simpleMessage("Jika Anda punya umpan balik terhadap fitur ini, mohon tinggalkan di"),
        "import": MessageLookupByLibrary.simpleMessage("Impor"),
        "import_data_from_another_device": MessageLookupByLibrary.simpleMessage("Impor data dari perangkat lain"),
        "import_from_twitter": MessageLookupByLibrary.simpleMessage("Impor dari Twitter"),
        "import_subscriptions": MessageLookupByLibrary.simpleMessage("Impor langganan"),
        ...
        "legacy_android_import": MessageLookupByLibrary.simpleMessage("Impor Android Lawas"),
        "let_the_developers_know_if_something_is_broken":
            MessageLookupByLibrary.simpleMessage("Biarkan pengembang tahu jika ada sesuatu yang rusak"),
        ...
        "never_send": MessageLookupByLibrary.simpleMessage("Jangan pernah kirim"),
        ...
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("Tidak ada langganan. Coba mencari atau mengimpor beberapa!"),
        "note_due_to_a_twitter_limitation_not_all_tweets_may_be_included":
            MessageLookupByLibrary.simpleMessage("Catatan: Karena batasan Twitter, tidak semua cuitan akan disertakan"),
        "ok": MessageLookupByLibrary.simpleMessage("Oke"),
        "oops_something_went_wrong": MessageLookupByLibrary.simpleMessage("Aduh! Ada yang tidak beres 🥲"),
        "pick_a_color": MessageLookupByLibrary.simpleMessage("Pilih sebuah warna!"),
        "pinned_tweet": MessageLookupByLibrary.simpleMessage("Cuitan yang disematkan"),
        "playback_speed": MessageLookupByLibrary.simpleMessage("Kecepatan pemutaran"),
        "please_check_your_internet_connection_error_message": m9,
        "please_enter_a_name": MessageLookupByLibrary.simpleMessage("Mohon masukkan nama"),
        ...
        "released_under_the_mit_license": MessageLookupByLibrary.simpleMessage("Dirilis di bawah Lisensi MIT"),
        "replying_to": MessageLookupByLibrary.simpleMessage("Membalas ke"),
        "report": MessageLookupByLibrary.simpleMessage("Lapor"),
        "report_a_bug": MessageLookupByLibrary.simpleMessage("Laporkan sebuah masalah"),
        "reporting_an_error": MessageLookupByLibrary.simpleMessage("Melaporkan galat"),
        "retry": MessageLookupByLibrary.simpleMessage("Ulang"),
        "save": MessageLookupByLibrary.simpleMessage("Simpan"),
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("Hemat bandwidth menggunakan gambar yang lebih kecil"),
        ...
        "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("Berhasil menyimpan media!"),
        ...
        "the_tweet_did_not_contain_any_text_this_is_unexpected":
            MessageLookupByLibrary.simpleMessage("Cuitan tidak mengandung teks apa pun. Ini tidak diduga"),
        ...
        "this_group_contains_no_subscriptions":
            MessageLookupByLibrary.simpleMessage("Grup ini tidak berisi langganan!"),
        ...
        "this_tweet_is_unavailable": MessageLookupByLibrary.simpleMessage("Cuitan ini tidak tersedia"),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone":
            MessageLookupByLibrary.simpleMessage("Pengguna ini tidak mengikuti siapa pun!"),
        "this_user_does_not_have_anyone_following_them":
            MessageLookupByLibrary.simpleMessage("Pengguna ini tidak punya seseorang yang mengikuti mereka!"),
        ...
        "timed_out_trying_to_send_the_ping":
            MessageLookupByLibrary.simpleMessage("Waktu habis mencoba untuk mengirim ping 😢"),
        ...
        "tweets_and_replies": MessageLookupByLibrary.simpleMessage("Cuitan & Balasan"),
        "unable_to_check_if_this_is_a_legacy_Android_device":
            MessageLookupByLibrary.simpleMessage("Tidak bisa memeriksa apakah ini adalah perangkat Android lawas."),
        "unable_to_find_the_app_package_info":
            MessageLookupByLibrary.simpleMessage("Tidak bisa menemukan info paket aplikasi"),
        "unable_to_find_the_available_trend_locations":
            MessageLookupByLibrary.simpleMessage("Tidak bisa menemukan lokasi tren yang tersedia."),
        "unable_to_find_your_saved_tweets":
            MessageLookupByLibrary.simpleMessage("Tidak bisa menemukan cuitan tersimpan Anda."),
        "unable_to_import": MessageLookupByLibrary.simpleMessage("Tidak bisa mengimpor"),
        "unable_to_load_subscription_groups": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat grup langganan"),
        "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat grup"),
        "unable_to_load_the_group_settings": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat pengaturan grup"),
        "unable_to_load_the_next_page_of_replies":
            MessageLookupByLibrary.simpleMessage("Tidak bisa memuat halaman balasan selanjutnya"),
        "unable_to_load_the_next_page_of_tweets":
            MessageLookupByLibrary.simpleMessage("Tidak dapat memuat halaman cuitan selanjutnya"),
        "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat profil"),
        "unable_to_load_the_search_results": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat hasil pencarian."),
        "unable_to_load_the_trends_for_widget_place_name": m16,
        "unable_to_load_the_tweet": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat cuitan"),
        "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("Tidak bisa memuat cuitan"),
        "unable_to_load_the_tweets_for_the_feed":
            MessageLookupByLibrary.simpleMessage("Tidak bisa memuat cuitan untuk umpan"),
        "unable_to_refresh_the_subscriptions_the_error_was_e": m17,
        "unable_to_run_the_database_migrations":
            MessageLookupByLibrary.simpleMessage("Tidak bisa menjalankan migrasi basis data"),
        "unable_to_save_the_media_twitter_returned_a_status_of_response_statusCode": m18,
        "unable_to_send_the_ping_e_to_string": m19,
        "unable_to_send_the_ping_the_status_code_was_response_statusCode": m20,
        "unable_to_stream_the_trend_location_preference":
            MessageLookupByLibrary.simpleMessage("Tidak bisa mengalirkan preferensi lokasi tren"),
        ...
        "use_true_black_for_the_dark_mode_theme":
            MessageLookupByLibrary.simpleMessage("Gunakan hitam pekat untuk tema mode gelap"),
        "user_not_found": MessageLookupByLibrary.simpleMessage("Pengguna tidak ditemukan"),
        ...
        "which_tab_is_shown_when_the_app_opens":
            MessageLookupByLibrary.simpleMessage("Bilah mana yang ditampilkan ketika aplikasi dibuka"),
        "would_you_like_to_enable_automatic_error_reporting":
            MessageLookupByLibrary.simpleMessage("Apakah Anda ingin mengaktifkan pelaporan galat otomatis?"),
        "yes": MessageLookupByLibrary.simpleMessage("Ya"),
        "you_have_not_saved_any_tweets_yet":
            MessageLookupByLibrary.simpleMessage("Anda belum menyimpan cuitan apa pun!"),
