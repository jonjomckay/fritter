...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(errorMessage) => "رجائاً تحقق من اتصال الشبكة لديك.\n\n${errorMessage}";
  ...
  static String m13(filePath) => "الملف غير موجود. رجائاً تأكد أنه موجو في ${filePath}";
  ...
  static String m16(widgetPlaceName) => "غير قادر على تحميل الترندات لـ${widgetPlaceName}";

  static String m17(e) => "غير قادر على تحديث الاشتراكات. الخطأ هو كالتالي ${e}";

  static String m18(responseStatusCode) => "تعذر حفظ الوسائط. أعاد تويتر حالة ${responseStatusCode}";

  static String m19(e) => "غير قادر على إرسال البنج. ${e}";

  static String m20(statusCode) => "تعذر إرسال الأمر ping. كان رمز الحالة ${statusCode}";

  static String m21(releaseVersion) => "حدّث إلى ${releaseVersion} عبر عميل الـF-Droid لديك";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "blue_theme_based_on_the_twitter_color_scheme":
            MessageLookupByLibrary.simpleMessage("السمة الزرقاء بنائاً على سمة تويتر"),
        ...
        "copied_address_to_clipboard": MessageLookupByLibrary.simpleMessage("نُسخ العنوان إلى الحافظة"),
        ...
        "could_not_find_any_tweets_by_this_user":
            MessageLookupByLibrary.simpleMessage("لم يتم العثور على أي تغريدة من هذا المستخدم!"),
        "could_not_find_any_tweets_from_the_last_7_days":
            MessageLookupByLibrary.simpleMessage("لم يُعثر على أي تغريدات من الأيام الـ7 الماضية!"),
        ...
        "if_you_have_any_feedback_on_this_feature_please_leave_it_on":
            MessageLookupByLibrary.simpleMessage("إذا كان لديك أي تعليقات عن هذه الميزة، رجائاً اكتبها هنا"),
        ...
        "it_looks_like_you_have_already_said_hello_from_this_version_of_fritter":
            MessageLookupByLibrary.simpleMessage("يبدوا أنك قد سلمت بالفعل من إصدار فريتر هذا!"),
        "it_looks_like_you_have_already_sent_a_ping_recently":
            MessageLookupByLibrary.simpleMessage("يبدوا أنك بالفعل قد أرسلت بينج حديثاً 🤔"),
        "joined": m7,
        ...
        "let_the_developers_know_if_something_is_broken":
            MessageLookupByLibrary.simpleMessage("دع المطورين يعرفون ما إذا كان هناك خطأ ما"),
        ...
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("لا اشتراكات. حاول أن تبحث أو أن تستورد البعض!"),
        "note_due_to_a_twitter_limitation_not_all_tweets_may_be_included":
            MessageLookupByLibrary.simpleMessage("ملاحظة: نظراً لقَيد معين من تويتر، قد لا يتم تضمين جميع التغريدات"),
        ...
        "released_under_the_mit_license":
            MessageLookupByLibrary.simpleMessage("منشور تحت رخصة الإم أي تي (MIT License)"),
        ...
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("الحفاظ على عرض النطاق (البيانات) باستخدام صور أصغر"),
        ...
        "sorry_the_replied_tweet_could_not_be_found":
            MessageLookupByLibrary.simpleMessage("عذرا ، لم يتم العثور على التغريدة التي تم الرد عليها!"),
        ...
        "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("تم حفظ الوسائط بنجاح!!"),
        ...
        "thanks_for_reporting_we_will_try_and_fix_it_in_no_time":
            MessageLookupByLibrary.simpleMessage("شكراً علي تبليغك لنا. سنحاول أن نصحله بأسرع ما يمكن!"),
        "the_connection_state_state_is_not_supported": m12,
        "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m13,
        "the_tweet_did_not_contain_any_text_this_is_unexpected":
            MessageLookupByLibrary.simpleMessage("التغريدة لا تحتوي على أي نص. هذا غير متوقع"),
        ...
        "this_group_contains_no_subscriptions":
            MessageLookupByLibrary.simpleMessage("هذه المجموعة لا تحتوي على أي مجموعات!"),
        "this_took_too_long_to_load_please_check_your_network_connection":
            MessageLookupByLibrary.simpleMessage("استغرق هذا وقتا طويلا للتحميل. رجائاً تأكد من اتصال الشبكة لديك!"),
        "this_tweet_is_unavailable": MessageLookupByLibrary.simpleMessage("هذه التغريدة غير متاحة"),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("هذا المستخدم لا يتابِع أحداً!"),
        "this_user_does_not_have_anyone_following_them":
            MessageLookupByLibrary.simpleMessage("هذا المستخدم ليس لديه أي اشخاص يتابعهم!"),
        ...
        "timed_out_trying_to_send_the_ping":
            MessageLookupByLibrary.simpleMessage("انتهت مهلة المحاولة لإرسال البنج 😢"),
        "to_import_subscriptions_from_an_existing_twitter_account_enter_your_username_below":
            MessageLookupByLibrary.simpleMessage("لاستيراد الاشتراكات من حساب تويتر موجود، أدخل اسم المستخدم أدناه."),
        ...
        "unable_to_check_if_this_is_a_legacy_Android_device":
            MessageLookupByLibrary.simpleMessage("غير قادر على التحقق ما إذا كان جهاز الأندرويد هذا قديم."),
        "unable_to_find_the_app_package_info":
            MessageLookupByLibrary.simpleMessage("غير قادر على العثور على معلومات حزمة التطبيق"),
        "unable_to_find_the_available_trend_locations":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحديد موقع الترندات."),
        "unable_to_find_your_saved_tweets":
            MessageLookupByLibrary.simpleMessage("غير قادر على العثور على تغريداتك المحفوظة."),
        "unable_to_import": MessageLookupByLibrary.simpleMessage("غير قادر على الاستيراد"),
        "unable_to_load_subscription_groups":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل مجموعات الاشتراك"),
        "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("غير قادر على تحميل المجموعة"),
        "unable_to_load_the_group_settings":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل إعدادات المجموعة"),
        "unable_to_load_the_list_of_follows":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل قائمة المتابَعون"),
        "unable_to_load_the_next_page_of_follows":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل الصفحة المتابَعون التالية"),
        "unable_to_load_the_next_page_of_replies":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل الصفحة التالية من الردود"),
        "unable_to_load_the_next_page_of_tweets":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل الصفحة التالية من التغريدات"),
        ...
        "unable_to_load_the_tweets_for_the_feed":
            MessageLookupByLibrary.simpleMessage("غير قادر على تحميل التغريدات للمُلقّم"),
        "unable_to_refresh_the_subscriptions_the_error_was_e": m17,
        "unable_to_run_the_database_migrations":
            MessageLookupByLibrary.simpleMessage("غير قادر على تشغيل تحديث قاعدة البيانات"),
        ...
        "unable_to_stream_the_trend_location_preference":
            MessageLookupByLibrary.simpleMessage("غير قادر على بث تفضيل موقع الترندات"),
        ...
        "use_true_black_for_the_dark_mode_theme":
            MessageLookupByLibrary.simpleMessage("استخدم ميزة الأسود الحقيقي للسمة الداكنة"),
        ...
        "which_tab_is_shown_when_the_app_opens":
            MessageLookupByLibrary.simpleMessage("أي تبويب يظهر عندما يفتح التطبيق"),
        "would_you_like_to_enable_automatic_error_reporting":
            MessageLookupByLibrary.simpleMessage("هل تُحب أن تفعل مُبَلغ الأخطاء الآلي؟"),
