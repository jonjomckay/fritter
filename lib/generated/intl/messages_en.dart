...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(errorMessage) => "Please check your Internet connection.\n\n${errorMessage}";
  ...
  static String m17(e) => "Unable to refresh the subscriptions. The error was ${e}";
  ...
  static String m20(statusCode) => "Unable to send the ping. The status code was ${statusCode}";

  static String m21(releaseVersion) => "Update to ${releaseVersion} through your F-Droid client";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("Save bandwidth using smaller images"),
        ...
        "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("Successfully saved the media!"),
        ...
        "this_tweet_is_unavailable": MessageLookupByLibrary.simpleMessage("This tweet is unavailable"),
        ...
        "unable_to_check_if_this_is_a_legacy_Android_device":
            MessageLookupByLibrary.simpleMessage("Unable to check if this is a legacy Android device."),
        "unable_to_find_the_app_package_info":
            MessageLookupByLibrary.simpleMessage("Unable to find the app\'s package info"),
