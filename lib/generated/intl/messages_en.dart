...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Are you sure you want to delete the subscription group ${name}?";
  ...
  static String m10(errorMessage) => "Please check your Internet connection.\n\n${errorMessage}";

  static String m11(releaseVersion) => "Tap to download ${releaseVersion}";

  static String m12(getMediaType) => "Tap to show ${getMediaType}";

  static String m13(filePath) => "The file does not exist. Please ensure it is located at ${filePath}";

  static String m14(thisTweetUserName, timeAgo) => "${thisTweetUserName} retweeted ${timeAgo}";
  ...
  static String m16(widgetPlaceName) => "Unable to load the trends for ${widgetPlaceName}";
  ...
  static String m19(statusCode) => "Unable to send the ping. The status code was ${statusCode}";

  static String m20(releaseVersion) => "Update to ${releaseVersion} through your F-Droid client";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activate_non_confirmation_bias_mode_label":
            MessageLookupByLibrary.simpleMessage("Activate non-confirmation bias mode"),
        ...
        "all_the_great_software_used_by_fritter":
            MessageLookupByLibrary.simpleMessage("All the great software used by Fritter"),
        "an_error_was_reported_to_sentry_thank_you":
            MessageLookupByLibrary.simpleMessage("An error was reported to Sentry. Thank you!"),
        "an_update_for_fritter_is_available":
            MessageLookupByLibrary.simpleMessage("An update for Fritter is available! 🚀"),
        ...
        "blue_theme_based_on_the_twitter_color_scheme":
            MessageLookupByLibrary.simpleMessage("Blue theme based on the Twitter color scheme"),
        ...
        "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Are you sure you want to close Fritter?"),
        ...
        "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Could not contact Twitter"),
        "could_not_find_any_tweets_by_this_user":
            MessageLookupByLibrary.simpleMessage("Couldn\'t find any tweets by this user!"),
        "could_not_find_any_tweets_from_the_last_7_days":
            MessageLookupByLibrary.simpleMessage("Couldn\'t find any tweets from the last 7 days!"),
        ...
        "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Enter your Twitter username"),
        ...
        "forbidden": MessageLookupByLibrary.simpleMessage("Twitter says access to this is forbidden"),
        "fritter": MessageLookupByLibrary.simpleMessage("Fritter"),
        "fritter_blue": MessageLookupByLibrary.simpleMessage("Fritter blue"),
        "functionality_unsupported":
            MessageLookupByLibrary.simpleMessage("This functionality is no longer supported by Twitter!"),
        "general": MessageLookupByLibrary.simpleMessage("General"),
        "group_name": m6,
        "groups": MessageLookupByLibrary.simpleMessage("Groups"),
        "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Help make Fritter even better"),
        "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Help support Fritter\'s future"),
        ...
        "hide_sensitive_tweets": MessageLookupByLibrary.simpleMessage("Hide sensitive tweets"),
        "home": MessageLookupByLibrary.simpleMessage("Home"),
        "if_you_have_any_feedback_on_this_feature_please_leave_it_on":
            MessageLookupByLibrary.simpleMessage("If you have any feedback on this feature, please leave it on"),
        "import": MessageLookupByLibrary.simpleMessage("Import"),
        "import_data_from_another_device": MessageLookupByLibrary.simpleMessage("Import data from another device"),
        "import_from_twitter": MessageLookupByLibrary.simpleMessage("Import from Twitter"),
        ...
        "include_retweets": MessageLookupByLibrary.simpleMessage("Include retweets"),
        ...
        "it_looks_like_you_have_already_sent_a_ping_recently":
            MessageLookupByLibrary.simpleMessage("It looks like you\'ve already sent a ping recently 🤔"),
        "joined": m8,
        ...
        "let_the_developers_know_if_something_is_broken":
            MessageLookupByLibrary.simpleMessage("Let the developers know if something\'s broken"),
        ...
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("No subscriptions. Try searching or importing some!"),
        "not_set": MessageLookupByLibrary.simpleMessage("Not set"),
        "note_due_to_a_twitter_limitation_not_all_tweets_may_be_included":
            MessageLookupByLibrary.simpleMessage("Note: Due to a Twitter limitation, not all tweets may be included"),
        ...
        "permission_not_granted":
            MessageLookupByLibrary.simpleMessage("Permission not granted. Please try again after granting!"),
        ...
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("Save bandwidth with smaller images"),
        ...
        "share_tweet_content": MessageLookupByLibrary.simpleMessage("Share tweet content"),
        "share_tweet_content_and_link": MessageLookupByLibrary.simpleMessage("Share tweet content and link"),
        "share_tweet_link": MessageLookupByLibrary.simpleMessage("Share tweet link"),
        "should_check_for_updates_description":
            MessageLookupByLibrary.simpleMessage("Check for updates when Fritter starts"),
        ...
        "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Something broke in Fritter."),
        ...
        "sorry_the_replied_tweet_could_not_be_found":
            MessageLookupByLibrary.simpleMessage("Sorry, the replied tweet could not be found!"),
        ...
        "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Thanks for helping Fritter! 💖"),
        "thanks_for_reporting_we_will_try_and_fix_it_in_no_time":
            MessageLookupByLibrary.simpleMessage("Thanks for reporting. We\'ll try and fix it in no time!"),
        "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m13,
        "the_github_issue": MessageLookupByLibrary.simpleMessage("the GitHub issue (#143)"),
        "the_tweet_did_not_contain_any_text_this_is_unexpected":
            MessageLookupByLibrary.simpleMessage("The tweet did not contain any text. This is unexpected"),
        ...
        "this_group_contains_no_subscriptions":
            MessageLookupByLibrary.simpleMessage("This group contains no subscriptions!"),
        "this_took_too_long_to_load_please_check_your_network_connection":
            MessageLookupByLibrary.simpleMessage("This took too long to load. Please check your network connection!"),
        "this_tweet_is_unavailable":
            MessageLookupByLibrary.simpleMessage("This tweet is unavailable. It was probably deleted."),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("This user does not follow anyone!"),
        "this_user_does_not_have_anyone_following_them":
            MessageLookupByLibrary.simpleMessage("This user does not have anyone following them!"),
        ...
        "timed_out_trying_to_send_the_ping":
            MessageLookupByLibrary.simpleMessage("Timed out trying to send the ping 😢"),
        ...
        "material_you": MessageLookupByLibrary.simpleMessage("Material 3?"),
        "tweets": MessageLookupByLibrary.simpleMessage("Tweets"),
        "tweets_and_replies": MessageLookupByLibrary.simpleMessage("Tweets & Replies"),
        "tweets_number": m15,
        "two_home_pages_required":
            MessageLookupByLibrary.simpleMessage("You need to have at least 2 home screen pages."),
        "unable_to_find_the_available_trend_locations":
            MessageLookupByLibrary.simpleMessage("Unable to find the available trend locations."),
        "unable_to_find_your_saved_tweets": MessageLookupByLibrary.simpleMessage("Unable to find your saved tweets."),
        ...
        "unable_to_load_subscription_groups":
            MessageLookupByLibrary.simpleMessage("Unable to load subscription groups"),
        ...
        "unable_to_load_the_list_of_follows":
            MessageLookupByLibrary.simpleMessage("Unable to load the list of follows"),
        "unable_to_load_the_next_page_of_follows":
            MessageLookupByLibrary.simpleMessage("Unable to load the next page of follows"),
        "unable_to_load_the_next_page_of_replies":
            MessageLookupByLibrary.simpleMessage("Unable to load the next page of replies"),
        "unable_to_load_the_next_page_of_tweets":
            MessageLookupByLibrary.simpleMessage("Unable to load the next page of tweets"),
        ...
        "unable_to_load_the_tweet": MessageLookupByLibrary.simpleMessage("Unable to load the tweet"),
        "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("Unable to load the tweets"),
        "unable_to_load_the_tweets_for_the_feed":
            MessageLookupByLibrary.simpleMessage("Unable to load the tweets for the feed"),
        "unable_to_refresh_the_subscriptions":
            MessageLookupByLibrary.simpleMessage("Unable to refresh the subscriptions"),
        "unable_to_run_the_database_migrations":
            MessageLookupByLibrary.simpleMessage("Unable to run the database migrations"),
        ...
        "unable_to_stream_the_trend_location_preference":
            MessageLookupByLibrary.simpleMessage("Unable to stream the trend location preference"),
        ...
        "use_material_you": MessageLookupByLibrary.simpleMessage("Use material 3"),
        "user_not_found": MessageLookupByLibrary.simpleMessage("User not found"),
        "username": MessageLookupByLibrary.simpleMessage("Username"),
        "version": MessageLookupByLibrary.simpleMessage("Version"),
        "when_a_new_app_update_is_available":
            MessageLookupByLibrary.simpleMessage("When a new app update is available"),
        "whether_errors_should_be_reported_to_sentry":
            MessageLookupByLibrary.simpleMessage("Whether errors should be reported to Sentry"),
        "whether_to_hide_tweets_marked_as_sensitive":
            MessageLookupByLibrary.simpleMessage("Whether to hide tweets marked as sensitive"),
        "which_tab_is_shown_when_the_app_opens":
            MessageLookupByLibrary.simpleMessage("Which tab is shown when the app opens"),
        "would_you_like_to_enable_automatic_error_reporting":
            MessageLookupByLibrary.simpleMessage("Would you like to enable automatic error reporting?"),
        "yes": MessageLookupByLibrary.simpleMessage("Yes"),
        "yes_please": MessageLookupByLibrary.simpleMessage("Yes, please"),
        "you_have_not_saved_any_tweets_yet": MessageLookupByLibrary.simpleMessage("You haven\'t saved any tweets yet!"),
        "you_must_have_at_least_2_home_screen_pages":
            MessageLookupByLibrary.simpleMessage("You must have at least 2 home screen pages"),
        ...
        "your_profile_must_be_public_otherwise_the_import_will_not_work":
            MessageLookupByLibrary.simpleMessage("Your profile must be public, otherwise the import will not work"),
