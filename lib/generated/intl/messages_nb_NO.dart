...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m12(state) => "${state}-tilkoblingstilstand støttes ikke";

  static String m13(filePath) =>
      "Filen finnes ikke. Sørg for at den er å finne i ${filePath}";

  static String m14(thisTweetUserName) => "${thisTweetUserName} re-tvitret";
  ...
  static String m17(e) =>
      "Kan ikke gjenoppfriske abonnementene. Feilen er ${e}";

  static String m18(responseStatusCode) =>
      "Kunne ikke lagre mediafilen. Twitter svarte med ${responseStatusCode}";

  static String m19(e) => "Kunne ikke sende ekkoforespørselen. ${e}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "unable_to_check_if_this_is_a_legacy_Android_device":
            MessageLookupByLibrary.simpleMessage(
                "Kunne ikke sjekke om dette er en gammeldags Android-enhet."),
        "unable_to_find_the_app_package_info":
            MessageLookupByLibrary.simpleMessage(
                "Fant ikke programmets pakkeinfo"),
