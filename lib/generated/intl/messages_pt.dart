...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "download_media_no_url": MessageLookupByLibrary.simpleMessage(
            "Incapaz de descarregar. Esta mídia pode estar disponível apenas como uma transmissão, que Fritter ainda não pode descarregar."),
        "download_path":
        ...
        "here_is_the_data_that_will_be_sent_it_will_only_be_used_to_determine_which_devices_and_languages_to_support_in_fritter_in_the_future":
            MessageLookupByLibrary.simpleMessage(
                "Aqui estão os dados que serão enviados. Ele será usado apenas para determinar quais aparelhos e idiomas serão suportados no Fritter no futuro."),
        ...
        "it_looks_like_you_have_already_said_hello_from_this_version_of_fritter":
            MessageLookupByLibrary.simpleMessage(
                "Parece que já disse olá desta versão do Fritter!"),
        ...
        "please_note_that_the_method_fritter_uses_to_import_subscriptions_is_heavily_rate_limited_by_twitter_so_this_may_fail_if_you_have_a_lot_of_followed_accounts":
            MessageLookupByLibrary.simpleMessage(
                "Observe que o método que o Fritter usa para importar inscrições é fortemente limitado pelo Twitter, portanto, isso pode falhar se estiver a seguir muitas contas."),
        "possibly_sensitive":
        ...
        "send_a_non_identifying_ping_to_let_me_know_you_are_using_fritter_and_to_help_future_development":
            MessageLookupByLibrary.simpleMessage(
                "Envie um ping não identificável para me informar que usa o Fritter e para ajudar no desenvolvimento futuro"),
        ...
        "something_just_went_wrong_in_fritter_and_an_error_report_has_been_generated":
            MessageLookupByLibrary.simpleMessage(
                "Algo deu errado no Fritter e um relatório de erro foi gerado. O relatório pode ser enviado aos programadores do Fritter para ajudar a corrigir o problema."),
        ...
        "your_device_is_running_a_version_of_android_older_than_kitKat_so_data_can_only_be_imported_from":
            MessageLookupByLibrary.simpleMessage(
                "O seu aparelho está a executar uma versão do Android anterior ao KitKat (4.4), portanto, os dados só podem ser importados de:"),
        "your_device_is_running_a_version_of_android_older_than_kitKat_so_the_export_can_only_be_saved_to":
            MessageLookupByLibrary.simpleMessage(
                "O seu aparelho está a executar uma versão do Android anterior ao KitKat (4.4), portanto, a exportação só pode ser salva em:"),
        "your_profile_must_be_public_otherwise_the_import_will_not_work":
            MessageLookupByLibrary.simpleMessage(
                "O seu perfil deve ser público, caso contrário a importação não funcionará"),
        "your_report_will_be_sent_to_fritter_sentry_project":
            MessageLookupByLibrary.simpleMessage(
                "O seu relatório será enviado ao projeto Sentry do Fritter e os detalhes de privacidade encontram-se em:")
      };
}
