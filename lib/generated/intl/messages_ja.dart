...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(responseStatusCode) => "メディアを保存できませんでした。Twitterから返されたステータス：${responseStatusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "all_the_great_software_used_by_fritter": MessageLookupByLibrary.simpleMessage("Fritterが使用するすばらしいソフトウェア"),
        ...
        "blue_theme_based_on_the_twitter_color_scheme": MessageLookupByLibrary.simpleMessage("Twitterの配色に基づいたブルーのテーマ"),
        ...
        "copied_address_to_clipboard": MessageLookupByLibrary.simpleMessage("アドレスをクリップボードにコピーしました"),
        "copied_version_to_clipboard": MessageLookupByLibrary.simpleMessage("バージョンをクリップボードにコピーしました"),
        "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Twitterにアクセスできませんでした"),
        "could_not_find_any_tweets_by_this_user": MessageLookupByLibrary.simpleMessage("このユーザのツイートが見つかりません！"),
        ...
        "data_imported_successfully": MessageLookupByLibrary.simpleMessage("データのインポートに成功しました"),
        ...
        "export_subscription_group_members": MessageLookupByLibrary.simpleMessage("購読グループのメンバーをエクスポート？"),
        "export_subscription_groups": MessageLookupByLibrary.simpleMessage("購読グループをエクスポート？"),
        "export_subscriptions": MessageLookupByLibrary.simpleMessage("購読をエクスポート？"),
        ...
        "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Fritterを改善するために協力する"),
        "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Fritterの将来を支援する"),
        "here_is_the_data_that_will_be_sent_it_will_only_be_used_to_determine_which_devices_and_languages_to_support_in_fritter_in_the_future":
            MessageLookupByLibrary.simpleMessage("以下が送信されるデータです。今後Fritterがサポートすべき端末と言語を特定するためにのみ使用されます。"),
        "if_you_have_any_feedback_on_this_feature_please_leave_it_on":
            MessageLookupByLibrary.simpleMessage("この機能にフィードバックがありましたら、こちらにお願いします"),
        "import": MessageLookupByLibrary.simpleMessage("インポート"),
        "import_data_from_another_device": MessageLookupByLibrary.simpleMessage("他の端末からデータをインポートする"),
        "import_from_twitter": MessageLookupByLibrary.simpleMessage("Twitterからインポート"),
        "import_subscriptions": MessageLookupByLibrary.simpleMessage("購読をインポートする"),
        ...
        "it_looks_like_you_have_already_said_hello_from_this_version_of_fritter":
            MessageLookupByLibrary.simpleMessage("既にこのバージョンのFritterからあいさつを送っているようです！"),
        "it_looks_like_you_have_already_sent_a_ping_recently":
            MessageLookupByLibrary.simpleMessage("既に最近pingを送信しているようです。🤔"),
        "joined": m7,
        "large": MessageLookupByLibrary.simpleMessage("大"),
        "legacy_android_import": MessageLookupByLibrary.simpleMessage("インポート(レガシー端末)"),
        "let_the_developers_know_if_something_is_broken": MessageLookupByLibrary.simpleMessage("不都合を開発者に知らせる"),
        ...
        "no_data_was_returned_which_should_never_happen_please_report_a_bug_if_possible":
            MessageLookupByLibrary.simpleMessage("データが返されませんでした。これは起こりえないことです。可能でしたらバグとして報告ください！"),
        "no_results": MessageLookupByLibrary.simpleMessage("結果なし"),
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("購読がありません。検索するか、インポートしてみてください！"),
        "note_due_to_a_twitter_limitation_not_all_tweets_may_be_included":
            MessageLookupByLibrary.simpleMessage("注意：ツイッターの制限により、全てのツイートが含まれない可能性があります"),
        "numberFormat_format_total_votes": m8,
        "ok": MessageLookupByLibrary.simpleMessage("OK"),
        "oops_something_went_wrong": MessageLookupByLibrary.simpleMessage("問題が発生しました🥲"),
        ...
        "please_enter_a_name": MessageLookupByLibrary.simpleMessage("グループ名を入力してください"),
        "please_make_sure_the_data_you_wish_to_import_is_located_there_then_press_the_import_button_below":
            MessageLookupByLibrary.simpleMessage("インポートしたいデータが存在することを確認し、下のインポートボタンを押してください。"),
        ...
        "released_under_the_mit_license": MessageLookupByLibrary.simpleMessage("MITライセンスで公開"),
        ...
        "save_bandwidth_using_smaller_images": MessageLookupByLibrary.simpleMessage("小さい画像を使用すると通信容量を削減できます"),
        ...
        "selecting_individual_accounts_to_import_and_assigning_groups_are_both_planned_for_the_future_already":
            MessageLookupByLibrary.simpleMessage("インポートするアカウントの選択やグループへの割り当ては今後対応予定です！"),
        "send": MessageLookupByLibrary.simpleMessage("送信"),
        "send_a_non_identifying_ping_to_let_me_know_you_are_using_fritter_and_to_help_future_development":
            MessageLookupByLibrary.simpleMessage("Fritterを使用していることを示す匿名のpingを開発者に送り、今後の開発を支援する"),
        ...
        "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Fritterに異常が発生しました。"),
        "something_just_went_wrong_in_fritter_and_an_error_report_has_been_generated":
            MessageLookupByLibrary.simpleMessage("Fritterに問題が発生し、エラーレポートが作成されました。問題を修正するため、開発者にレポートを送信することができます。"),
        "sorry_the_replied_tweet_could_not_be_found": MessageLookupByLibrary.simpleMessage("返信ツイートが見つかりませんでした！"),
        ...
        "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("メディアの保存に成功しました！"),
        "system": MessageLookupByLibrary.simpleMessage("システム"),
        "tap_to_download_release_version": m10,
        "tap_to_show_getMediaType_item_type": m11,
        "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Fritterを支援いただきありがとうございます！💖"),
        "thanks_for_reporting_we_will_try_and_fix_it_in_no_time":
            MessageLookupByLibrary.simpleMessage("レポートありがとうございます。できるだけ早く修正いたします！"),
        ...
        "there_were_no_trends_returned_this_is_unexpected_please_report_as_a_bug_if_possible":
            MessageLookupByLibrary.simpleMessage("トレンドが返されませんでした。予期せぬ動作です！可能でしたらバグとして報告ください。"),
        "this_group_contains_no_subscriptions": MessageLookupByLibrary.simpleMessage("このグループは空です！"),
        "this_took_too_long_to_load_please_check_your_network_connection":
            MessageLookupByLibrary.simpleMessage("読み込みに時間がかかり過ぎています。ネットワーク接続を確認してください！"),
        "this_tweet_is_unavailable": MessageLookupByLibrary.simpleMessage("ツイートが利用できません"),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("このユーザは誰もフォローしていません！"),
        "this_user_does_not_have_anyone_following_them": MessageLookupByLibrary.simpleMessage("このユーザをフォローしている人はいません！"),
        ...
        "timed_out_trying_to_send_the_ping": MessageLookupByLibrary.simpleMessage("Pingの送信がタイムアウトしました😢"),
        "to_import_subscriptions_from_an_existing_twitter_account_enter_your_username_below":
            MessageLookupByLibrary.simpleMessage("Twitterアカウントから購読をインポートするには、以下にユーザ名を入力してください。"),
        ...
        "unable_to_find_the_app_package_info": MessageLookupByLibrary.simpleMessage("アプリのパッケージ情報が見つかりませんでした"),
        ...
        "unable_to_load_subscription_groups": MessageLookupByLibrary.simpleMessage("購読グループの読み込みに失敗しました"),
        "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("グループの読み込みに失敗しました"),
        "unable_to_load_the_group_settings": MessageLookupByLibrary.simpleMessage("グループ設定の読み込みに失敗しました"),
        "unable_to_load_the_list_of_follows": MessageLookupByLibrary.simpleMessage("フォローリストを読み込めませんでした"),
        "unable_to_load_the_next_page_of_follows": MessageLookupByLibrary.simpleMessage("次ページのフォローを読み込めませんでした"),
        "unable_to_load_the_next_page_of_replies": MessageLookupByLibrary.simpleMessage("次ページの返信の読み込みに失敗しました"),
        "unable_to_load_the_next_page_of_tweets": MessageLookupByLibrary.simpleMessage("次ページのツイートの読み込みに失敗しました"),
        "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("プロフィールを読み込めませんでした"),
        "unable_to_load_the_search_results": MessageLookupByLibrary.simpleMessage("検索結果の読み込みに失敗しました。"),
        "unable_to_load_the_trends_for_widget_place_name": m16,
        "unable_to_load_the_tweet": MessageLookupByLibrary.simpleMessage("ツイートの読み込みに失敗しました"),
        "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("ツイートを読み込めませんでした"),
        ...
        "unable_to_run_the_database_migrations": MessageLookupByLibrary.simpleMessage("データベース移行ができませんでした"),
        ...
        "use_true_black_for_the_dark_mode_theme": MessageLookupByLibrary.simpleMessage("ダークテーマで完全な黒を使用する"),
        ...
        "whether_errors_should_be_reported_to_sentry": MessageLookupByLibrary.simpleMessage("エラーをSentryに送信するか"),
        "which_tab_is_shown_when_the_app_opens": MessageLookupByLibrary.simpleMessage("アプリを起動したときにどのタブを表示するか"),
        "would_you_like_to_enable_automatic_error_reporting": MessageLookupByLibrary.simpleMessage("自動エラー報告を有効化しますか？"),
        "yes": MessageLookupByLibrary.simpleMessage("はい"),
        "you_have_not_saved_any_tweets_yet": MessageLookupByLibrary.simpleMessage("まだツイートを保存していません！"),
