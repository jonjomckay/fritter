                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text.rich(TextSpan(
                                                              children: [
                                                                TextSpan(text: '${widget.profile.user.friendsCount}', style: const TextStyle(fontSize: metadataTextSize, fontWeight: FontWeight.w500)),
                                                                TextSpan(text: ' ${L10n.current.following.toLowerCase()}', style: const TextStyle(fontSize: metadataTextSize))
                                                              ]
                                                          )),
                                                        ],
                                                      ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text.rich(TextSpan(
                                                              children: [
                                                                TextSpan(text: '${widget.profile.user.followersCount}', style: const TextStyle(fontSize: metadataTextSize, fontWeight: FontWeight.w500)),
                                                                TextSpan(text: ' ${L10n.current.followers.toLowerCase()}', style: const TextStyle(fontSize: metadataTextSize))
                                                              ]
                                                          )),
                                                        ],
                                                      ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          const SizedBox(width: 4),
                                                          Text(user.location!, style: const TextStyle(fontSize: metadataTextSize)),
                                                        ],
                                                      ),
                                                    ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          var textStyle = const TextStyle(fontSize: metadataTextSize);
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(L10n.of(context)
                                                              ...
                                                              style: const TextStyle(fontSize: metadataTextSize)
                                                          ),
                                                        ],
                                                      ),
                                                    ),
